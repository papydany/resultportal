 ...
 include_once"../function/headerTop.php";
       ...
       <?php  leftnavigation(); ?>
        ...
        <div class="col-sm-12 whitecolor">
           <div class="col-sm-12 headbanner" style="margin-bottom:15px;">View Broad Sheet <a href="individual_report.php" class="btn btn-danger btn-sm navbar-right">View Individual Report Sheet</a></div>
    ...
    <select class='form-control' name="class_id" id="class" required>
     ...
     <div class="form-group">
         <div class="col-sm-4 col-sm-offset-4">
              <input type="submit" name="submit" class="btn btn-warning" id="view_result"  value="View Broad Sheet">
