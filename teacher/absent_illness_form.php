...
<div class="col-sm-12" style="padding-top:15px;">
 ...
 echo' <div class="col-sm-12 formBg">
    <div class="col-sm-12 teachheader">
                No Of Absent Day Due To illness
     ...
     echo"<div class='col-sm-10 col-sm-offset-1'>";
        ...
        switch ($_GET['s']) {
          ...
          echo "<p class='success'>  Input Successfull .</p>";
            ...
            case '2':
          echo "<p class='error'>  you did not insert or update any .</p>";
            break;
        ...
        echo" <a href='absent_illness.php' class='btn btn-success'>Go Back To Add  </a>
        </div>";
         }
...
$student_info = select_student_reg_all($_SESSION['session'] ,$_SESSION['class_id'], $_SESSION['subclass'], $_SESSION['term']);
 ...
 <a href='absent_illness.php' class='btn btn-success btn-block'> Click To Go Back </a>";
...
<th>absent of days due to illness</th>
<th>Nature of illness</th>


</tr>
<form class='form-group' method='post' action='insert_absent_illness.php'>";
foreach ($student_info as $key => $value) {

$s++;

$r= select_absent_illness($value['student_id'],$value['student_no'],$_SESSION['class_id'],$_SESSION['subclass'],$value['reg_id'],$_SESSION['term'],$_SESSION['session']);
$i++;
$no =count($r);
if(count($r) == 0){
//e#
...
<td><input class='form-control navbar-right' type='number' name='absent[$i]' id='absent$i' onKeyUp=\"CA(this,'check[$i]') \"  value=''></td>
<td><input class='form-control' type='text' name='reason[$i]' value='' id='reason$i' onKeyUp=\"CA(this,'check[$i]') \"></td>
...
<td>".$value['student_no']."<input type='hidden' name='student_no[$i]' value='".$value['student_no']."'></td>
<td><input class='form-control' type='text' size='20' name='absent[$i]' id='absent$i' onKeyUp=\"CA(this,'check[$i]') \"  value='".$v['absent']."'></td>
<td><input class='form-control' type='text' name='reason[$i]'  id='reason$i' onKeyUp=\"CA(this,'check[$i]') \" value='".$v['reason']."'></td>
