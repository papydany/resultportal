 ...
 echo' <div class="col-sm-12 formBg">
    <div class="col-sm-12 teachheader">
     ...
     echo"<div class='col-sm-10 col-sm-offset-1'>";
        ...
        echo" <a href='attendance.php' class='btn btn-success'>Go Back To Add Attendance </a>
        </div>";
         }
...
<form class='form-group' method='post' action='insert_attendance.php'>";
foreach ($student_info as $key => $value) {

$s++;

$r= select_attendance($value['student_id'],$value['student_no'],$_SESSION['class_id'],$_SESSION['subclass'],$value['reg_id'],$_SESSION['term'],$_SESSION['session']);
$i++;
$no =count($r);
if(count($r) == 0){
//e#
...
<td><input class='form-control navbar-right' type='text' name='present[$i]' id='present$i' onKeyUp=\"CA(this,'check[$i]') \"  value=''></td>
<td><input class='form-control' type='text' name='punctual[$i]' value='' id='punctual$i' onKeyUp=\"CA(this,'check[$i]') \"></td>

<td><input class='form-control' type='text' name='absent[$i]' onKeyUp=\"CA(this,'check[$i]') \" value='' id='absent$i' ></td>
...
<td>".$value['student_no']."<input type='hidden' name='student_no[$i]' value='".$value['student_no']."'></td>
<td><input class='form-control' type='text' size='20' name='present[$i]' id='present$i' onKeyUp=\"CA(this,'check[$i]') \"  value='".$v['present']."'></td>
<td><input class='form-control' type='text' name='punctual[$i]'  id='punctual$i' onKeyUp=\"CA(this,'check[$i]') \" value='".$v['punctual']."'></td>
<td><input class='form-control' type='text' name='absent[$i]' value='".$v['absent']."' id='absent$i' onKeyUp=\"CA(this,'check[$i]') \" ></td>
</tr>";
